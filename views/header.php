...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="http://jingfeipeng.tech/MVC-Twitter-App/style.css">
    <title>Hello, world!</title>
  </head>
  <body>
  
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	  <a class="navbar-brand" href="http://jingfeipeng.tech/MVC-Twitter-App/">Twitter-Clone</a>
